                        ...
                        <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td> <img src="{{ asset($brand->brand_image) }}" style="height:40px; width:50px"> </td>
                                <td>
                                ...
                                {{ Carbon\Carbon::parse($brand->created_at)->diffForHumans() }}
                                 ...
                                 <a href="{{ url('softdelete/brand/'. $brand->id) }}" onclick="return confirm('Are u sure?')" class="btn btn-sm btn-danger">Delete</a>
                                  </td>
